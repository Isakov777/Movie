    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yaer', models.PositiveIntegerField(default=2022, verbose_name='дата выхода')),
                ...
                ('fees_in_workld', models.PositiveIntegerField(default=0, help_text='указать сумму в долларах', verbose_name='сборы в мире')),
                ('url', models.SlugField(max_length=255, unique=True)),
                ('draft', models.BooleanField(default=False, verbose_name='Черновик')),
                ('actors', models.ManyToManyField(related_name='movie_actor', to='movie.Actor', verbose_name='актеры')),
                ...
                ('directors', models.ManyToManyField(related_name='movie_director', to='movie.Actor', verbose_name='режисёр')),
                ('geners', models.ManyToManyField(to='movie.Genre', verbose_name='жанры')),
            ],
            options={
                'verbose_name': 'Movie',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='movie.review', verbose_name='Подотзыв')),
            ],
            options={
                'verbose_name': 'Отзыв',
